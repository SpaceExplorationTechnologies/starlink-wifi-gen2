...
ifdef ANTI_ROLLBACK_FIP_VERSION
# TFW_NVCTR_VAL and NTFW_NVCTR_VAL are the values used in ATF's auth_mod.c
# as anti-rollback counters.
TFW_NVCTR_VAL  =       $(ANTI_ROLLBACK_FIP_VERSION)
NTFW_NVCTR_VAL =       $(TFW_NVCTR_VAL)
$(info ANTI_ROLLBACK_FIP_VERSION set to $(ANTI_ROLLBACK_FIP_VERSION))
else
$(error ANTI_ROLLBACK_FIP_VERSION should be defined when building BL2/FIP.)
endif
