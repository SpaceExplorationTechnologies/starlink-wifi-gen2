...
define KernelPackage/btmtkuart
  SUBMENU:=$(OTHER_MENU)
  TITLE:=Bluetooth support for MediaTek serial devices
  DEPENDS:=+kmod-bluetooth
  KCONFIG:=CONFIG_BT_MTKUART CONFIG_SERIAL_DEV_BUS=y
  FILES:=$(LINUX_DIR)/drivers/bluetooth/btmtkuart.ko
  AUTOLOAD:=$(call AutoProbe,btmtkuart)
endef

define KernelPackage/btmtkuart/description
  Kernel support for MediaTek serial bluetooth devices
endef
