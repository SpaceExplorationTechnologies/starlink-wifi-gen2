	...
	struct _HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	MtCmdGetThermalSensorResult(pAd, 0, ATECtrl->control_band_idx, &SensorResult);
	...
	struct _HQA_CMD_FRAME *HqaCmdFrame)
{
	...
	if (Value == 0) {
		RTMP_IO_WRITE32(pAd->hdev_ctrl, RMAC_RFCR, RFCR);
		RTMP_IO_WRITE32(pAd->hdev_ctrl, RMAC_OMA0R0, OMA0R0);
		RTMP_IO_WRITE32(pAd->hdev_ctrl, RMAC_OMA0R1, OMA0R1);
		RTMP_IO_WRITE32(pAd->hdev_ctrl, RMAC_OMA1R0, OMA1R0);
		RTMP_IO_WRITE32(pAd->hdev_ctrl, RMAC_OMA1R1, OMA1R1);
		RTMP_IO_WRITE32(pAd->hdev_ctrl, RMAC_OMA2R0, OMA2R0);
		RTMP_IO_WRITE32(pAd->hdev_ctrl, RMAC_OMA2R1, OMA2R1);
		RTMP_IO_WRITE32(pAd->hdev_ctrl, RMAC_OMA3R0, OMA3R0);
		RTMP_IO_WRITE32(pAd->hdev_ctrl, RMAC_OMA3R1, OMA3R1);
		RTMP_IO_WRITE32(pAd->hdev_ctrl, RMAC_OMA4R0, OMA4R0);
		RTMP_IO_WRITE32(pAd->hdev_ctrl, RMAC_OMA4R1, OMA4R1);
		...
		/* backup CR value */
		RTMP_IO_READ32(pAd->hdev_ctrl, RMAC_RFCR, &RFCR);
		RTMP_IO_READ32(pAd->hdev_ctrl, RMAC_OMA0R0, &OMA0R0);
		RTMP_IO_READ32(pAd->hdev_ctrl, RMAC_OMA0R1, &OMA0R1);
		RTMP_IO_READ32(pAd->hdev_ctrl, RMAC_OMA1R0, &OMA1R0);
		RTMP_IO_READ32(pAd->hdev_ctrl, RMAC_OMA1R1, &OMA1R1);
		RTMP_IO_READ32(pAd->hdev_ctrl, RMAC_OMA2R0, &OMA2R0);
		RTMP_IO_READ32(pAd->hdev_ctrl, RMAC_OMA2R1, &OMA2R1);
		RTMP_IO_READ32(pAd->hdev_ctrl, RMAC_OMA3R0, &OMA3R0);
		RTMP_IO_READ32(pAd->hdev_ctrl, RMAC_OMA3R1, &OMA3R1);
		RTMP_IO_READ32(pAd->hdev_ctrl, RMAC_OMA4R0, &OMA4R0);
		RTMP_IO_READ32(pAd->hdev_ctrl, RMAC_OMA4R1, &OMA4R1);
		...
		RTMP_IO_WRITE32(pAd->hdev_ctrl, RMAC_RFCR, 0x001FEFFB);
		RTMP_IO_WRITE32(pAd->hdev_ctrl, RMAC_OMA0R0, 0x00000000);
		RTMP_IO_WRITE32(pAd->hdev_ctrl, RMAC_OMA0R1, 0x00000000);
		RTMP_IO_WRITE32(pAd->hdev_ctrl, RMAC_OMA1R0, 0x00000000);
		RTMP_IO_WRITE32(pAd->hdev_ctrl, RMAC_OMA1R1, 0x00000000);
		RTMP_IO_WRITE32(pAd->hdev_ctrl, RMAC_OMA2R0, 0x00000000);
		RTMP_IO_WRITE32(pAd->hdev_ctrl, RMAC_OMA2R1, 0x00000000);
		RTMP_IO_WRITE32(pAd->hdev_ctrl, RMAC_OMA3R0, 0x00000000);
		RTMP_IO_WRITE32(pAd->hdev_ctrl, RMAC_OMA3R1, 0x00000000);
		RTMP_IO_WRITE32(pAd->hdev_ctrl, RMAC_OMA4R0, 0x00000000);
		RTMP_IO_WRITE32(pAd->hdev_ctrl, RMAC_OMA4R1, 0x00000000);
