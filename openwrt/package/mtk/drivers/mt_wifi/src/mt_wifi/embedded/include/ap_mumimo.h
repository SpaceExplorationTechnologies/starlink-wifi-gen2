...
enum {
	...
	MU_HQA_SET_CALC_SU_LQ,
		...
		/*Falcon MURU Start*/
	MURU_SET_ALGO_CTRL,
	MURU_SET_GLOBAL_PROT_SEC_CTRL,
	MURU_SET_TX_DATA_SEC_CTRL,
	MURU_SET_TRIG_DATA_SEC_CTRL,
	MURU_SET_TRIG_SND_SEC_CTRL,
	MURU_GET_ALGO_CTRL,
	MURU_GET_GLOBAL_PROT_SEC_CTRL,
	MURU_GET_TX_DATA_SEC_CTRL,
	MURU_GET_TRIG_DATA_SEC_CTRL,
	MURU_GET_TRIG_SND_SEC_CTRL
	/*MURU END*/
#endif
};
...
enum {
	...
	MU_EVENT_HQA_STATUS,
#ifdef CFG_SUPPORT_FALCON_MURU
	MURU_EVENT_GET_ALGO_CTRL,
	MURU_EVENT_GET_GLOBAL_PROT_SEC_CTRL,
	MURU_EVENT_GET_TX_DATA_SEC_CTRL,
	MURU_EVENT_GET_TRIG_DATA_SEC_CTRL,
	MURU_EVENT_GET_TRIG_SND_SEC_CTRL,
#endif
};
...
typedef struct _CMD_MURU_ALGO_CTRL {
	UINT_32		ucRuAlgoTimeOut:32;/*@us*/
} CMD_MURU_ALGO_CTRL, *P_CMD_MURU_ALGO_CTRL;
...
typedef struct _EVENT_MURU_GET_ALGO_CTRL {
	UINT32 u4EventId;
	CMD_MURU_ALGO_CTRL rEntry;
} EVENT_MURU_GET_ALGO_CTRL, *P_EVENT_MURU_GET_ALGO_CTRL;
...
typedef struct _EVENT_SHOW_MURU_ALGO_CTRL {
	UINT32	u4EventId;
	UINT32	u4Index;
#ifdef RT_BIG_ENDIAN
		UINT_32	ucRuAlgoTimeOut:32;/*@us*/
		...
		UINT_32 ucRuAlgoTimeOut:32;/*@us*/
#endif
} EVENT_SHOW_MURU_ALGO_CTRL, *P_EVENT_SHOW_MURU_ALGO_CTRL;
