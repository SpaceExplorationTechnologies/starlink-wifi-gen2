...
/* WTBL ADM format */
typedef enum {
	VOW_WTBL_ADM_CTT_CTB = 0,
	VOW_WTBL_ADM_CDT_CRT,
	VOW_WTBL_ADM_CDT_CTB,
	VOW_WTBL_ADM_CTB_CRB
} VOW_WTBL_ADM_MODE_T;
...
INT vow_set_rx_airtime(struct _RTMP_ADAPTER *pAd, UINT8 cmd, UINT32 subcmd);
