...
#define IEEE80211_VHT_CAP_MAX_MPDU_LEN_MASK 0x3
#define IEEE80211_VHT_CAP_SUPPORT_CH_WIDTH_SET_SHIFT 2
#define IEEE80211_VHT_CAP_SUPPORT_CH_WIDTH_SET_MASK (0x3 << 2)
#define IEEE80211_VHT_CAP_RX_LDPC (1 << 4)
#define IEEE80211_VHT_CAP_BW80_SGI (1 << 5)
#define IEEE80211_VHT_CAP_BW160_8080_SGI (1 << 6)
#define IEEE80211_VHT_CAP_TX_STBC (1 << 7)
#define IEEE80211_VHT_CAP_RX_STBC_SHIFT 8
#define IEEE80211_VHT_CAP_RX_STBC_MASK (0x7 << 8)
#define IEEE80211_VHT_CAP_SU_BFER (1 << 11)
#define IEEE80211_VHT_CAP_SU_BFEE (1 << 12)
#define IEEE80211_VHT_CAP_BFEE_STS_SHIFT 13
#define IEEE80211_VHT_CAP_BFEE_STS_MASK (0x7 << 13)
#define IEEE80211_VHT_CAP_NUM_SOUND_DIM_SHIFT 16
#define IEEE80211_VHT_CAP_NUM_SOUND_DIM_MASK (0x7 << 16)
#define IEEE80211_VHT_CAP_MU_BFER (1 << 19)
#define IEEE80211_VHT_CAP_MU_BFEE (1 << 20)
#define IEEE80211_VHT_CAP_TXOP_PS (1 << 21)
#define IEEE80211_VHT_CAP_HTC (1 << 22)
#define IEEE80211_VHT_CAP_MAX_AMPDU_LEN_EXP_SHIFT 23
#define IEEE80211_VHT_CAP_MAX_AMPDU_LEN_EXP_MASK (0x7 << 23)
#define IEEE80211_VHT_CAP_LINK_ADAPT_SHIFT 26
#define IEEE80211_VHT_CAP_LINK_ADAPT_MASK (0x3 << 26)
#define IEEE80211_VHT_CAP_RX_ANT_PATTERN_CONSIST (1 << 28)
#define IEEE80211_VHT_CAP_TX_ANT_PATTERN_CONSIST (1 << 29)
#define IIEE80211_VHT_CAP_EXT_NSS_BW_SHIFT 30
#define IIEE80211_VHT_CAP_EXT_NSS_BW_MASK (0x3 << 30)
/* vht_caps_ie.vht_txrx_mcs_nss */
#define VHT_MCS_NSS_MASK 0x3
#define IEEE80211_VHT_MCS_1SS_SHIFT 0
#define IEEE80211_VHT_MCS_1SS_MASK VHT_MCS_NSS_MASK
#define IEEE80211_VHT_MCS_2SS_SHIFT 2
#define IEEE80211_VHT_MCS_2SS_MASK (VHT_MCS_NSS_MASK << 2)
#define IEEE80211_VHT_MCS_3SS_SHIFT 4
#define IEEE80211_VHT_MCS_3SS_MASK (VHT_MCS_NSS_MASK << 4)
#define IEEE80211_VHT_MCS_4SS_SHIFT 6
#define IEEE80211_VHT_MCS_4SS_MASK (VHT_MCS_NSS_MASK << 6)
#define IEEE80211_VHT_MCS_5SS_SHIFT 8
#define IEEE80211_VHT_MCS_5SS_MASK (VHT_MCS_NSS_MASK << 8)
#define IEEE80211_VHT_MCS_6SS_SHIFT 10
#define IEEE80211_VHT_MCS_6SS_MASK (VHT_MCS_NSS_MASK << 10)
#define IEEE80211_VHT_MCS_7SS_SHIFT 12
#define IEEE80211_VHT_MCS_7SS_MASK (VHT_MCS_NSS_MASK << 12)
#define IEEE80211_VHT_MCS_8SS_SHIFT 14
#define IEEE80211_VHT_MCS_8SS_MASK (VHT_MCS_NSS_MASK << 14)

#define VHT_MAX_MCS_NSS(nss, mcs)\
	((mcs) << (IEEE80211_VHT_MCS_ ## nss ## SS_SHIFT))

#define IEEE80211_VHT_MCS_MAX_NSTS_TOTAL_SHIFT 13
#define IEEE80211_VHT_MCS_MAX_NSTS_TOTAL_MASK (0x7 << 13)
#define IEEE80211_VHT_MCS_EXT_NSS_BW_CAPABLE (1 << 13)
...
/* vht_oper_mode.field */
#define IEEE80211_VHT_OP_MODE_CH_WIDTH_SHIFT 0
#define IEEE80211_VHT_OP_MODE_CH_WIDTH_MASK 0x3
#define IEEE80211_VHT_OP_MODE_BW160_8080 (1 << 2)
#define IEEE80211_VHT_OP_MODE_NO_LDPC (1 << 3)
#define IEEE80211_VHT_OP_MODE_RX_NSS_SHIFT 4
#define IEEE80211_VHT_OP_MODE_RX_NSS_MASK (0x7 << 4)
#define IEEE80211_VHT_OP_MODE_RX_NSS_TYPE (1 << 7)
