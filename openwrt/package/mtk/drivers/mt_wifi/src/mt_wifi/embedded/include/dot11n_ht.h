...
/* ht_op_info.info_1 */
#define IEEE80211_HT_OPINFO_SEC_CH_OFFSET_MASK 0x3
#define IEEE80211_HT_OPINFO_SEC_STA_CH_WIDTH (1 << 2)
#define IEEE80211_HT_OPINFO_RIFS_MODE (1 << 3)
/* ht_op_info.info_2 */
#define IEEE80211_HT_OPINFO_HT_PROTECTION_MASK 0x3
#define IEEE80211_HT_OPINFO_NON_GF_STA_PRESENT (1 << 2)
#define IEEE80211_HT_OPINFO_OBSS_NONHT_STA_PRESENT (1 << 4)
#define IEEE80211_HT_OPINFO_CCFS_2_SHIFT 5
#define IEEE80211_HT_OPINFO_CCFS_2_MASK (0x7FF << 5)
#define IEEE80211_HT_OPINFO_DUAL_BEACON (1 << 22)
#define IEEE80211_HT_OPINFO_DUAL_CTS (1 << 23)
#define IEEE80211_HT_OPINFO_STBC_BEACON (1 << 24)
#define IEEE80211_HT_OPINFO_LSIG_TXOP_PROTECTION (1 << 25)
#define IEEE80211_HT_PCO_ACTIVE (1 << 26)
#define IEEE80211_HT_PCO_PHASE (1 << 27)
...
#define IEEE80211_HT_RX_HIGHEST_DATA_RATE_MASK 0x3FF
#define IEEE80211_HT_TX_MCS_SET (1 << 0)
#define IEEE80211_HT_TX_RX_MCS_SET_NOT_EQU (1 << 1)
#define IEEE80211_HT_TX_MAX_NSS_SUPPORT_SHIFT 2
#define IEEE80211_HT_TX_MAX_NSS_SUPPORT_MASK (0x3 << 2)
#define IEEE80211_HT_TX_UNEQU_MODULATION (1 << 4)
