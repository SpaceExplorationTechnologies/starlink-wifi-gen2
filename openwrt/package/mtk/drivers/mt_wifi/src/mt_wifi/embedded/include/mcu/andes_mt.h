...
VOID ExtEventWifiSpectrumIQDataHandler(struct _RTMP_ADAPTER *pAd, UINT8 *pData, UINT32 Length);
...
VOID ExtEventICapIQDataHandler(struct _RTMP_ADAPTER *pAd, UINT8 *pData, UINT32 Length);
