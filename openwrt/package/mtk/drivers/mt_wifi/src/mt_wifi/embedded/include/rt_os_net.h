...
VOID mt_int_md_enable(struct _RTMP_ADAPTER *pAd, unsigned int mode);
VOID mt_int_md_disable(struct _RTMP_ADAPTER *pAd, unsigned int mode);
#endif
VOID isr_handle(VOID *pAdSrc);
#ifdef MT7626_E2_SUPPORT
VOID isr_handle_md(VOID *pAdSrc);
#endif
