...
#define MT_INT2_SOURCE_CSR	(MT_HIF_BASE + 0x01c0)
#define MT_INT2_MASK_CSR	(MT_HIF_BASE + 0x01d4)
#endif
#ifdef ERR_RECOVERY
...
#ifdef MT7626_E2_SUPPORT
#define MT_INT2_R2_DONE		(1<<0)
#define MT_INT2_R3_DONE		(1<<1)
#define MT_INT2_RX_DLY		(1<<9)
#endif
...
#ifdef MT7626_E2_SUPPORT
#define MT_INT2_RX			(MT_INT2_R2_DONE)
#define MT_INT2_RX_DATA		(MT_INT2_R2_DONE)
#endif
...
/*
	CR MD_WPDMA GLO CFG
*/
#define MT_MD_WPDMA_GLO_CFG	    (MT_HIF_BASE + 0x01D0)
#endif
...
#ifdef MT7626_E2_SUPPORT
#define MT_MD_WPDMA_DELAY_INT_CFG	(MT_HIF_BASE + 0x01D8)
#endif
...
typedef struct _PCI_HIF_T {
	...
	UINT32 IntPending;
#ifdef MT7626_E2_SUPPORT
	UINT32 IntEnableReg_md;
	UINT32 intDisableMask_md;
	UINT32 IntPending_md;
#endif
