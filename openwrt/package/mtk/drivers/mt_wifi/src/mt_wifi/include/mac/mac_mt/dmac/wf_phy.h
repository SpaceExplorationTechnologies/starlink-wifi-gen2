...
#if defined(MT7626)
#define WF_PHY1_BASE			0x40000

/* CONNAC TALOS PHY1 BAND0 MACRO */
#define TALOS_PHY1_RO_BAND0_PHYCTRL_STS0			(WF_PHY1_BASE + 0x0210) /* 0x82080210 */
#define TALOS_PHY1_RO_BAND0_PHYCTRL_STS1			(WF_PHY1_BASE + 0x0214) /* 0x82080214 */
#define TALOS_PHY1_RO_BAND0_PHYCTRL_STS2			(WF_PHY1_BASE + 0x0218) /* 0x82080218 */
#define TALOS_PHY1_RO_BAND0_PHYCTRL_STS3			(WF_PHY1_BASE + 0x021C) /* 0x8208021C */
#define TALOS_PHY1_RO_BAND0_PHYCTRL_STS4			(WF_PHY1_BASE + 0x0220) /* 0x82080220 */
#define TALOS_PHY1_RO_BAND0_PHYCTRL_STS5			(WF_PHY1_BASE + 0x0224) /* 0x82080224 */
#define TALOS_PHY1_RO_BAND0_PHYCTRL_STS6			(WF_PHY1_BASE + 0x0228) /* 0x82080228 */
#define TALOS_PHY1_RO_BAND0_PHYCTRL_STS7			(WF_PHY1_BASE + 0x022C) /* 0x8208022C */
#define TALOS_PHY1_RO_BAND0_PHYCTRL_STS8			(WF_PHY1_BASE + 0x0230) /* 0x82080230 */
#define TALOS_PHY1_RO_BAND0_PHYCTRL_STS9			(WF_PHY1_BASE + 0x0234) /* 0x82080234 */
#define TALOS_PHY1_RO_BAND0_PHYCTRL_MU				(WF_PHY1_BASE + 0x0238) /* 0x82080238 */
#define TALOS_PHY1_CR_BAND0_STSCNT_EN_CTRL			(WF_PHY1_BASE + 0x0414) /* 0x82080414 */

/* CONNAC TALOS PHY1 BAND1 MACRO */
#define TALOS_PHY1_CR_BAND1_STSCNT_EN_CTRL			(WF_PHY1_BASE + 0x1414) /* 0x82081414 */

#define TALOS_PHY_RXTD_12				(WF_PHY1_BASE + 0x2230) /* 0x82082230 */
#define TALOS_PHY1_RXTD1_0				(WF_PHY1_BASE + 0x2600) /* 0x82082600 */
#define TALOS_PHY1_RXTD1_1				(WF_PHY1_BASE + 0x2604) /* 0x82082604 */
#define TALOS_PHY1_RXTD1_4				(WF_PHY1_BASE + 0x2610) /* 0x82082610 */


/* CONNAC TALOS PHY DBG SIGNAL MACRO */
#define TALOS_WF_RXTD_PHY1_RO_AGC_DEBUG_0_RX0_ADDR		(WF_PHY1_BASE + 0x3218) /* 0x82083218 */
#define TALOS_WF_RXTD_PHY1_RO_AGC_DEBUG_0_RX1_ADDR		(WF_PHY1_BASE + 0x3618) /* 0x82083618 */
#define TALOS_WF_RXTD_PHY1_RO_AGC_DEBUG_0_RX2_ADDR		(WF_PHY1_BASE + 0x3A18) /* 0x82083A18 */
#define TALOS_WF_RXTD_PHY1_RO_AGC_DEBUG_0_RX3_ADDR		(WF_PHY1_BASE + 0x3E18) /* 0x82083E18 */
#define TALOS_WF_RXTD_PHY1_RO_AGC_DEBUG_2_RX0_ADDR		(WF_PHY1_BASE + 0x3220) /* 0x82083220 */
#define TALOS_WF_RXTD_PHY1_RO_AGC_DEBUG_2_RX1_ADDR		(WF_PHY1_BASE + 0x3620) /* 0x82083620 */
#define TALOS_WF_RXTD_PHY1_RO_AGC_DEBUG_2_RX2_ADDR		(WF_PHY1_BASE + 0x3A20) /* 0x82083A20 */
#define TALOS_WF_RXTD_PHY1_RO_AGC_DEBUG_2_RX3_ADDR		(WF_PHY1_BASE + 0x3E20) /* 0x82083E20 */
#define TALOS_WF_PHY1_CTRL_CR_DBGSGD_MODE_ADDR			(WF_PHY1_BASE + 0x0604) /* 0x82080604 */
