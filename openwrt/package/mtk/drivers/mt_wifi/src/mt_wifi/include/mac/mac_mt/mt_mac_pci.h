...
#define RTMP_ASIC_INTERRUPT_DISABLE(_pAd)		\
	do {			\
		...
		HIF_IO_WRITE32((_pAd->hdev_ctrl), MT_INT2_MASK_CSR, 0); /*0: disable*/\
...
#define RTMP_ASIC_INTERRUPT_ENABLE(_pAd)\
	do {				\
		...
		HIF_IO_WRITE32((_pAd->hdev_ctrl), MT_INT2_MASK_CSR, (_pAd)->PciHif.IntEnableReg_md);     /* 1:enable */	\
...
#define RTMP_IRQ_ENABLE(_pAd)  \
	do {						\
		...
		HIF_IO_WRITE32((_pAd->hdev_ctrl), MT_INT2_SOURCE_CSR, 0xffffffff); \
