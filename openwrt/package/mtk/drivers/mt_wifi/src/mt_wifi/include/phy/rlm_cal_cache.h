...
typedef struct _PRE_CAL_INFO_MT7663_T
{
    UINT8  ucDataToFromFlash;
    UINT8  ucDataValid;
    UINT16 u2BitMap;
...
} PRE_CAL_INFO_MT7663_T, *P_PRE_CAL_INFO_MT7663_T;
...
#ifdef PRE_CAL_MT7663_SUPPORT
INT GroupPreCalInfoAlloc_7663(struct _RTMP_ADAPTER *pAd, VOID **pptr, UINT16 idx, UINT32 length);
