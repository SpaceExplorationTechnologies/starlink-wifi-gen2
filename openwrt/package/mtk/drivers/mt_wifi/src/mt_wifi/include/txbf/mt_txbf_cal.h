...
#if defined(MT7626)
#define IBF_PHASE_EEPROM_START      0x150

#define IBF_LNA_PHASE_G0_ADDR       IBF_PHASE_EEPROM_START
#define IBF_LNA_PHASE_G1_ADDR       (IBF_LNA_PHASE_G0_ADDR  + 0x12)
#define IBF_LNA_PHASE_G2_ADDR       (IBF_LNA_PHASE_G1_ADDR  + 0x12)
#define IBF_LNA_PHASE_G3_ADDR       (IBF_LNA_PHASE_G2_ADDR  + 0x12)
#define IBF_LNA_PHASE_G4_ADDR       (IBF_LNA_PHASE_G3_ADDR  + 0x12)
#define IBF_LNA_PHASE_G5_ADDR       (IBF_LNA_PHASE_G4_ADDR  + 0x12)
#define IBF_LNA_PHASE_G6_ADDR       (IBF_LNA_PHASE_G5_ADDR  + 0x12)
#define IBF_LNA_PHASE_G7_ADDR       (IBF_LNA_PHASE_G6_ADDR  + 0x12)
#define IBF_LNA_PHASE_G8_ADDR       (IBF_LNA_PHASE_G7_ADDR  + 0x12)
#else
#define IBF_PHASE_EEPROM_START      0x320

#define IBF_LNA_PHASE_G0_ADDR       IBF_PHASE_EEPROM_START
#define IBF_LNA_PHASE_G1_ADDR       (IBF_LNA_PHASE_G0_ADDR  + 0x10)
#define IBF_LNA_PHASE_G2_ADDR       (IBF_LNA_PHASE_G1_ADDR  + 0x10)
#define IBF_LNA_PHASE_G3_ADDR       (IBF_LNA_PHASE_G2_ADDR  + 0x10)
#define IBF_LNA_PHASE_G4_ADDR       (IBF_LNA_PHASE_G3_ADDR  + 0x10)
#define IBF_LNA_PHASE_G5_ADDR       (IBF_LNA_PHASE_G4_ADDR  + 0x10)
#define IBF_LNA_PHASE_G6_ADDR       (IBF_LNA_PHASE_G5_ADDR  + 0x10)
#define IBF_LNA_PHASE_G7_ADDR       (IBF_LNA_PHASE_G6_ADDR  + 0x10)
#define IBF_LNA_PHASE_G8_ADDR       (IBF_LNA_PHASE_G7_ADDR  + 0x10)
#endif
...
#if defined(MT7626)
typedef struct _MT7626_IBF_PHASE_OUT {
	UINT8 ucC0_L;
	UINT8 ucC1_L;
	UINT8 ucC2_L;
	UINT8 ucC3_L;
	...
	UINT_8 ucC2_UH;
	UINT_8 ucC3_UH;
} MT7626_IBF_PHASE_OUT, *P_MT7626_IBF_PHASE_OUT;

typedef struct _MT7626_IBF_PHASE_G0_T {
	UINT_8 ucG0_R0_UH;
	UINT_8 ucG0_R0_H;
	UINT_8 ucG0_R0_M;
	UINT_8 ucG0_R0_L;
	...
	UINT_8 ucG0_M_T1_H;
	UINT_8 ucG0_M_T2_H;
} MT7626_IBF_PHASE_G0_T, *P_MT7626_IBF_PHASE_G0_T;

typedef struct _MT7626_IBF_PHASE_Gx_T {
	UINT_8 ucGx_R0_UH;
	UINT_8 ucGx_R0_H;
	UINT_8 ucGx_R0_M;
	UINT_8 ucGx_R0_L;
	...
	UINT_8 ucGx_M_T1_H;
	UINT_8 ucGx_M_T2_H;
} MT7626_IBF_PHASE_Gx_T, *P_MT7626_IBF_PHASE_Gx_T;
#endif
...
VOID mt_iBFPhaseComp(IN struct _RTMP_ADAPTER *pAd,
						IN UCHAR ucGroup,
						IN PCHAR pCmdBuf);

VOID mt_iBFPhaseCalInit(IN struct _RTMP_ADAPTER *pAd);

VOID mt_iBFPhaseFreeMem(IN struct _RTMP_ADAPTER *pAd);

VOID mt_iBFPhaseCalE2PInit(IN struct _RTMP_ADAPTER *pAd);

VOID mt_iBFPhaseCalE2PUpdate(IN struct _RTMP_ADAPTER *pAd,
						IN UCHAR   ucGroup,
						IN BOOLEAN fgSX2,
						IN UCHAR   ucUpdateAllType);

VOID mt_iBFPhaseCalReport(IN struct _RTMP_ADAPTER *pAd,
...
#if defined(MT7626)
VOID mt7626_eBFPfmuMemAlloc(IN struct _RTMP_ADAPTER *pAd,
						IN PCHAR pPfmuMemRow,
						IN PCHAR pPfmuMemCol);

VOID mt7626_iBFPfmuMemAlloc(IN struct _RTMP_ADAPTER *pAd,
						IN PCHAR pPfmuMemRow,
						IN PCHAR pPfmuMemCol);
#endif /* MT7626 */
