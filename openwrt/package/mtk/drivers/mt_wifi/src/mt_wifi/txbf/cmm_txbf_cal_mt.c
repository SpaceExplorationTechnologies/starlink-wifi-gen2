...
#if defined(MT7626)
VOID mt7626_eBFPfmuMemAlloc(IN PRTMP_ADAPTER pAd, IN PCHAR pPfmuMemRow, IN PCHAR pPfmuMemCol)
{
	pPfmuMemRow[0] = 0;
	pPfmuMemRow[1] = 1;
	pPfmuMemRow[2] = 2;
...
VOID mt7626_iBFPfmuMemAlloc(IN PRTMP_ADAPTER pAd, IN PCHAR pPfmuMemRow, IN PCHAR pPfmuMemCol)
{
	pPfmuMemRow[0] = 4;
	pPfmuMemRow[1] = 5;
	pPfmuMemRow[2] = 6;
...
#if defined(MT7626)
	u1IbfCalPhaseStructLenG0 = sizeof(MT7626_IBF_PHASE_G0_T);
	u1IbfCalPhaseStructLenGx = sizeof(MT7626_IBF_PHASE_Gx_T);
#endif
...
{
#if defined(MT7626)
	MT7626_IBF_PHASE_Gx_T iBfPhaseGx;
	MT7626_IBF_PHASE_G0_T iBfPhaseG0;
#endif
		   ...
		   IN PUCHAR  pBuf)
{
	...
	MT7626_IBF_PHASE_G0_T	iBfPhaseG0;
	MT7626_IBF_PHASE_Gx_T	iBfPhaseGx;
	P_MT7626_IBF_PHASE_G0_T piBfPhaseG0;
	P_MT7626_IBF_PHASE_Gx_T piBfPhaseGx;
	MT7626_IBF_PHASE_OUT	iBfPhaseOut;
#endif
	UCHAR  ucGroupIdx;
	PUCHAR pucIBfPhaseG;
	UINT_8 u1IbfCalPhaseStructLenG0 = 0;
	...
	u1IbfCalPhaseStructLenG0 = sizeof(MT7626_IBF_PHASE_G0_T);
	u1IbfCalPhaseStructLenGx = sizeof(MT7626_IBF_PHASE_Gx_T);
	u1IbfPhaseOutStructLen   = sizeof(MT7626_IBF_PHASE_OUT);
#endif
...
#if defined(MT7626)
			piBfPhaseGx = (P_MT7626_IBF_PHASE_Gx_T)&pAd->piBfPhaseGx[ucGroupIdx * u1IbfCalPhaseStructLenGx];
#endif
...
#if defined(MT7626)
			piBfPhaseG0 = (P_MT7626_IBF_PHASE_G0_T)pAd->piBfPhaseG0;
#endif
