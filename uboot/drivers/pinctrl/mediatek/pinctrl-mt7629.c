...
/* SpaceX: UART0 RX disabled once fused / secure-boot enabled */
/* All this takes is setting pin 69 to any function but 1 */
static int mt7629_uart0_txd_only_pins[] = { 68, 69, };
static int mt7629_uart0_txd_only_funcs[] = { 1, 2, };
...
static const struct mtk_group_desc mt7629_groups[] = {
	...
	PINCTRL_PIN_GROUP("uart0_txd_only", mt7629_uart0_txd_only), // SpaceX secure boot
...
static const char *const mt7629_uart_groups[] = { "uart1_0_txd_rxd",
						...
						"uart2_1_cts_rts",
						"uart0_txd_rxd",
						"uart0_txd_only", /* SpaceX secure boot */ };
