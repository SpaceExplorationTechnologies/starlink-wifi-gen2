...
static int mtk_gpio_set_dir_flags(struct udevice *dev, unsigned int offset,
				    ulong flags)
{
...
static int mtk_gpio_get_dir_flags(struct udevice *dev, unsigned int offset,
				    ulong *flags)
{
	ulong dir_flags = 0;
...
static const struct dm_gpio_ops mtk_gpio_ops = {
	...
	.set_dir_flags = mtk_gpio_set_dir_flags,
	.get_dir_flags = mtk_gpio_get_dir_flags,
};
