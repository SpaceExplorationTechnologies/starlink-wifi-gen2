...
#define FIT_AR_VER_PROP		"fit_ar_ver"
...
/**
 * fit_conf_get_fit_ar_ver() - Get fit anti-rollback version
 *
 * @fit: pointer to the FIT format image header
 * @conf_noffset: component configuration node offset
 * @fit_ar_ver: pointer to the uint32_t, will hold fit anti-rollback version
 *
 * fit_conf_get_fit_ar_ver() finds fit anti-rollback version property in a
 ...
 *    -1, on failure
 */
int fit_conf_get_fit_ar_ver(const void *fit, int conf_noffset, ulong *fit_ar_ver);
